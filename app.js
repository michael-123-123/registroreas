...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const wasteTypeOptions = {
        hazardous: ['ACIDO CLORHIDRICO', 'ALCOHOL', 'ALCOHOL GEL', 'ALEACION PARA AMALGAMA DENTAL', 'AMPOLLAS Y FRASCOS CON RESTOS DE MEDICAMENTOS', 'AMPOLLETAS FLUORESCENTES', 'APOSITOS CON FORMALINA', 'ARENA CONTAMINADA CON HIDROCARBUROS', 'ASERRIN CONTAMINADO CON HIDROCARBUROS', 'ATROPINA SULFATO', 'BATERIAS DE NIQUEL-CADMIO', 'BATERIAS DE PLOMO', 'BATERIAS NI - MH', 'CAL SODADA', 'CILINDROS VACIOS DE GAS ISOBUTANO PROPANO', 'CITOTOXICOS', 'DETERGENTES INDUSTRIALES', 'ELEMENTOS CON PLOMO', 'ENVASES CON RESTOS DE SUSTANCIAS PELIGROSAS', 'ETER ETILICO', 'FENOL', 'FORMALINA', 'INHALADORES', 'LIQUIDO REVELADOR', 'MEDICAMENTOS VENCIDOS', 'MERCURIO CONTENIDO EN TERMOMETROS O ESFIGMOMANOMETROS', 'MERCURIO CROMO', 'MEZCLA DE AMONIOS CUATERNARIOS', 'NITRITO DE SODIO', 'ORTOFTALDEHIDO', 'OXIDO DE ETILENO', 'PEROXIDO DE HIDROGENO', 'PILAS', 'PLACAS DE PLOMO', 'PLATA NITRATO', 'REACTIVOS DE LABORATORIO', 'RESIDUOS DE ACEITES Y LUBRICANTES (EXCEPTO LAS EMULSIONES)', 'SOLUCION PAF', 'SOLVENTE DE QUEMAR', 'TERMOMETROS CON MERCURIO', 'TONER', 'TUBOS FLUORESCentes', 'VIOLETA GENCIANA CRITAL', 'YODO SUBLIMADO', 'SOLUCION GIEMSA'],
